    ...
    return (
      <aside className="mongo-terminal mongo-terminal--collapsed">
        <button type="button" className="mongo-terminal__reopen" onClick={onToggle}>
          <span>MongoDB</span>
          <span className="mongo-terminal__reopen-hint">Show terminal</span>
        </button>
      </aside>
    );
  }
  ...
  return (
    <aside className="mongo-terminal">
      <div className="mongo-terminal__header">
        ...
        <button type="button" className="mongo-terminal__hide" onClick={onToggle}>
          Hide
        </button>
      </div>
      ...
      <div className="mongo-terminal__body">
        {actions.length === 0 ? (
          <p className="mongo-terminal__empty">
            MongoDB request payloads and return values will appear here after you run the demo.
          </p>
        ) : null}
