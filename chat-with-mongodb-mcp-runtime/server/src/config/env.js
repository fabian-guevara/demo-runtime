...
const env = {
  ...
  clientPort: Number(process.env.CLIENT_PORT ?? 5178),
  clientOrigin: process.env.CLIENT_ORIGIN ?? "http://127.0.0.1:5178",
  mongodbUri: process.env.MONGODB_URI ?? "",
  mongodbDbName: process.env.MONGODB_DB_NAME ?? "network_monitoring",
  ...
  manualsVectorIndex: process.env.MANUALS_VECTOR_INDEX ?? "manuals_vector_index",
